...
let jsonObject = window.json || {
    content: "Você ~~não pode~~ fazer `isso`.```py\nE isso.\nprint('Olá')```\n*italico* ou _italico_     __*italico sublinhado*__\n**negrito**     __**negrito**__\n***negrito italico***  __***negrito italico sublinhado***__\n__sublinhado__     ~~Cortado~~",
    embed: {
        title: "Olá ~~pessoas~~ do mundo :wave:",
        description: "Você pode utilizar [links](https://godly.sazuto.com/) ou emojis :smile: 😎\n```\nAh, e blocos também\n```",
        color: 0x41f097,
        ...
        fields: [
            {
                name: "Campo 1, *lorem* **ipsum**, ~~dolor~~",
                value: "Valor do campo"
            },
            {
                name: "Campo 2",
                value: "Você pode utilizar emojis customizados <:r_neko:904193186761674835>. <:beje_kkk_ds:848638171868823622>",
                inline: false
            },
            {
                name: "Field alinhado",
                value: "Campos podem ser alinhados",
                inline: true
            },
            {
                name: "Field alinhado",
            ...
            {
                name: "Outro campo",
                value: "> <- Também não esqueci sobre isso",
                inline: false
            }
        ]
    }
